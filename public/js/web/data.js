...
/*
 * Списка звуков здесь нет намеренно. На эталоне он был, но играть эти
 * звуки некому: в браузере уведомление звучит системным сигналом, а на
 * телефоне будильник берёт звук из настроек Android. Пять названий, за
 * которыми ничего не стоит, хуже их отсутствия.
 */
