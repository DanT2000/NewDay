...
function loadConfig(env = process.env) {
  ...
  return {
    ...
    /*
     * Пароль панели администратора из окружения.
     *
     * Владелец сервера правит переменные, а не базу: доступа к SQLite внутри
     * контейнера у него обычно нет. Пока не задан, работает пароль, заданный в
     * самой панели, а на свежем сервере — заводской, и тот уже только из
     * локальной сети (см. routes/adminPanel.js).
     */
