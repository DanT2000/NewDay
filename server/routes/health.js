 ...
 * доехали ли до контейнера переменные. Без него проверить нечем: настройки
 * закрыты админом, а вход требует подтверждённой почты — и неподключённый
 * помощник обнаружился бы только тогда, когда человек нажал кнопку и ничего
 * не произошло.
 */
module.exports = function healthRouter(db, { ai, push } = {}) {
