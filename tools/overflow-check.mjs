...
for (const scale of SCALES) {
  /*
   * Третья ширина — 360 пикселей, самый узкий ходовой телефон.
   *
   * Проверка смотрела 390 и на нём всё влезало, а на 360 четыре кнопки
   * сегмента налезали друг на друга: «Выключено» рвалось на «Выключ / ено».
   * Поймалось только скриншотом для магазина — то есть глазами, случайно.
   * Дешевле проверять три ширины, чем ловить такое на карточке приложения.
   */
  for (const [подпись, w, h, mobile] of [
    ['компьютер', 1440, 900, false],
    ['телефон', 390, 844, true],
    ['узкий телефон', 360, 640, true],
  ]) {
