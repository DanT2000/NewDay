...
# Проверяем делом: ставим 1.0.7 с сайта, обновляем на 1.0.9 без удаления,
...
now=$(version_now)
echo "   стало: $now"
[ "$now" = "1.0.9" ] || fail "версия не обновилась: $now"
...
echo
echo "ИТОГ: сборка с сайта 1.0.7 обновилась до магазинной 1.0.9 без удаления,"
